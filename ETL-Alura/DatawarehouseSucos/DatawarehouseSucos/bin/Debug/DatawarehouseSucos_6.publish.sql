...
GO
PRINT N'Rename refactoring operation with key 4da73775-42aa-40d2-9f14-8ddeef2d1987 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key ca433929-00a9-459c-9bcd-12b92bfddb70 is skipped, element [dbo].[Fato_001].[Cod_Organi] (SqlSimpleColumn) will not be renamed to Cod_Organizacional';


GO
PRINT N'Rename refactoring operation with key 37c27836-a74c-4dd0-8f4e-020fc40209b3 is skipped, element [dbo].[Fato_001].[imposto] (SqlSimpleColumn) will not be renamed to Imposto';
